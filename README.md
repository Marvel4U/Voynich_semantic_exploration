...
<img src="plots/word_length_stats.png" alt="Word length distributions for Currier A vs B" width="50%">

#### Zipf distribution
The Zipf curve mostly aligns with what is seen in other languages.
<img src="plots/Zipf_stats.png" alt="Zipf fit check for Voynich tokens" width="50%">
...
<img src="plots/bigram_heatmap_a_b.png" alt="Word bigram heatmaps A/B" width="50%">
...
<img src="plots/bigram_heatmap_ref_shared.png" alt="Shared vs reference bigram heatmap" width="50%">
...
<img src="plots/word_start_bigrams_a_b.png" alt="Word-start bigrams, Currier A vs B" width="50%">

<img src="plots/word_end_bigrams_a_b.png" alt="Word-end bigrams, Currier A vs B" width="50%">

Trigrams show a similar split to the bigram plots, with the known overrepresentation of the -edy ending in Currier B.

<img src="plots/word_start_trigrams_a_b.png" alt="Word-start trigrams, Currier A vs B" width="50%">

<img src="plots/word_end_trigrams_a_b.png" alt="Word-end trigrams, Currier A vs B" width="50%">
