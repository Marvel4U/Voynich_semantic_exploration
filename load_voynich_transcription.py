...
Files: reads data/IT2a-n.txt, writes JSON outputs in data/
"""
...
source_path = data_dir / "IT2a-n.txt"
        ...
        if page_match:
            if current_page:
                if current_paragraph:
                    ...
                    current_paragraph = []
                pages[current_page] = {"info": current_info, "paragraphs": paragraphs}
                paragraphs = []
...
def generate_outputs():
    ...
    page_index = {"ordered_pages": ordered_pages, "page_to_number": page_to_number}
